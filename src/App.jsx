    ...
    const init = async () => {
      try {
        ...
        if (currentUser) {
          ...
          const isAdmin = await gunAuthService.isAdmin(currentUser.pub);
          ...
          console.log('🔄 Restored session - admin status from Gun:', isAdmin);
          console.log('👤 User public key:', currentUser.pub);
